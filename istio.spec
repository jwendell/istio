...
%global git_commit 65dd56a95262b389c37fee3aeab9be369b291a23
...
rm -rf istio*
mkdir istio
tar xfz %{_topdir}/SOURCES/istio.tar.gz -C istio --strip=1

cd istio
cp istiorc .istiorc.mk
...
%license istio/LICENSE
%doc istio/README.md istio/code-of-conduct.md istio/CONTRIBUTING.md
