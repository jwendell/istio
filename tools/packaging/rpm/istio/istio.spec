...
%global git_commit fd5254d87df6733d09972d53d532564d6c499c2b
...
make pilot-discovery pilot-agent istioctl sidecar-injector mixc mixs citadel galley node-agent
...
binaries=(pilot-discovery pilot-agent istioctl sidecar-injector mixs mixc istio_ca galley node-agent)
pushd .
...
ln -s /var/lib/istio /etc/istio 2> /dev/null
...
%files node-agent
%attr(0755,root,root) %{_bindir}/node-agent
